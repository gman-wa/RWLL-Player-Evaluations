 ...
 */
    ...
    $request['hitting_power'] = isset($_GET['hitting_power']) && $_GET['hitting_power'] != "" ? (float) filter_var($_GET['hitting_power'], FILTER_SANITIZE_NUMBER_FLOAT,FILTER_FLAG_ALLOW_FRACTION) : FALSE;
    ...
    $request['pitching_velocity'] = isset($_GET['pitching_velocity']) && $_GET['pitching_velocity'] != "" ? (float) filter_var($_GET['pitching_velocity'], FILTER_SANITIZE_NUMBER_FLOAT,FILTER_FLAG_ALLOW_FRACTION) : FALSE;
